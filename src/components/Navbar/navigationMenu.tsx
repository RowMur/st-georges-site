...
const navigationMenuTriggerStyle = cva(
  "group inline-flex h-10 w-max items-center justify-center rounded-md px-4 py-2 text-md font-bold transition-colors hover:bg-grey text-darkBlue focus:bg-grey disabled:pointer-events-none disabled:opacity-50"
);
